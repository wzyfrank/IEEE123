function [Voltage_output, phasors] = ieee123_iter2(loads, Zbus, Cbus)
...
% disp(A * Z150150R* AH *I150150R)
% disp(eig([v31, S3132; ctranspose(S3132), l3132]))
% disp(diag(S2733) / 1000)
% disp(diag(S2631) / 1000)
disp(diag(A * S150R149 * AH) / 1000)

% disp(diag(A *v25 * AH) / (Vbase * Vbase));
% disp(diag(v25R) / (Vbase * Vbase));
% disp(S2525R);
% disp(Z2525R);
% disp(l2525R);
% disp(diag(v26) / (Vbase * Vbase));
